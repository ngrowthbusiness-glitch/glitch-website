    ...
    <>
      ...
      <nav
        style={{
          ...
          borderBottom: "1px solid rgba(0,212,160,0.22)",
        }}
      >
        {/* Logo */}
        <Link
        ...
        >
          ...
          >
            Nicola{" "}
            <span style={{ color: "#00d4a0" }}>Serrao</span>
          </span>
        </Link>
              ...
              <Link
                ...
                onMouseEnter={(e) => {
                  if (pathname !== link.href)
                    (e.target as HTMLElement).style.color = "#00d4a0";
                }}
                onMouseLeave={(e) => {
                  if (pathname !== link.href)
          ...
          <li>
            <a
              ...
              onMouseEnter={(e) => {
                ...
                el.style.borderColor = "#00d4a0";
              }}
              onMouseLeave={(e) => {
                const el = e.currentTarget;
                el.style.background = "rgba(0,212,160,0.10)";
