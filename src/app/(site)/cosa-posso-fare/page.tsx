      ...
      <div className="cpf-page s-page">
        ...
        <div className="cpf-hero">
          ...
          <div className="cpf-wa-block animate-fade-up delay-300">
            <svg className="cpf-wa-icon" viewBox="0 0 24 24" fill="currentColor">
            ...
            <a href={SITE.whatsapp} className="s-btn-primary" style={{ width: '100%', justifyContent: 'center' }}>
              Scrivimi su WhatsApp
            </a>
            <span className="cpf-wa-note">Senza impegno. Zero spam.</span>
          </div>
        </div>
        ...
        <div className="s-cta">
          ...
          <p className="cpf-cta-desc">Una call per capire se ha senso lavorare insieme. Nessun pitch, nessun preventivo.</p>
          <div className="cpf-cta-buttons">
